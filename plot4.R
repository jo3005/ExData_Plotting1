...
with(power_data,plot(x=DateTime,y=Voltage,
                     type="l",
...
legend("top",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"),lty=1,bty="n")

with(power_data,plot(x=DateTime,y=Global_reactive_power,
                     type="l",
